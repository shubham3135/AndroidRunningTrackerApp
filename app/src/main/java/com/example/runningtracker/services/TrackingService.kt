...
class TrackingService: LifecycleService() {
    ...
    companion object{
        val timeRunImMillis = MutableLiveData<Long>()
    ...
    private fun startTimer(){
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!){
                ...
                timeRunImMillis.postValue(timeRun+lapTime)
                if (timeRunImMillis.value!!>= lastSecondTimeStamp + 1000L){
